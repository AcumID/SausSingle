...
// in simulator we redefine to format for SausSingle Developer console
...
{\
	NSString * exceptionName = [@"org.saussingle." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.saussingle";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UISausSingleNativeItemNone = -1, 
	UISausSingleNativeItemSpinner = -2,
	UISausSingleNativeItemProgressBar = -3,
	
	UISausSingleNativeItemSlider = -4,
	UISausSingleNativeItemSwitch = -5,
	UISausSingleNativeItemMultiButton = -6,
	UISausSingleNativeItemSegmented = -7,
	
	UISausSingleNativeItemTextView = -8,
	UISausSingleNativeItemTextField = -9,
	UISausSingleNativeItemSearchBar = -10,
	
	UISausSingleNativeItemPicker = -11,
	UISausSingleNativeItemDatePicker = -12,
	
	UISausSingleNativeItemInfoLight = -13,
	UISausSingleNativeItemInfoDark = -14,
	
	UISausSingleNativeItemDisclosure = -15,
	
	UISausSingleNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all SausSingle instances of
