 ...
 * Copyright (c) 2009-2011 by SausSingle, Inc. All Rights Reserved.
...
//@interface SausSingleObject : NSObject
//@end

@interface SausSingleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SausSingleObject class]])
		{
			for (NSString *key in [[(SausSingleObject*)o modules] allKeys])
			{
