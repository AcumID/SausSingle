...
@interface SausSingleObject : KrollCoverageObject {
#else
@interface SausSingleObject : KrollObject {
#endif
@private
...
extern NSString * SausSingle$ModuleRequireFormat;
