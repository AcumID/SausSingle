...
/**
 Base class for all SausSingle views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the SausSingle view hierarchy (such as wrapped iOS UIViews) was touched.
